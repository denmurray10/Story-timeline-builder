...
class BookForm(forms.ModelForm):
    ...
    class Meta:
        model = Book
        fields = [
            'title', 'series_order', 'description', 'word_count_target',
            'current_word_count', 'status', 'started_date', 'completed_date'
        ]
        widgets = {
...
class CharacterForm(forms.ModelForm):
    ...
    class Meta:
        model = Character
        fields = [
            'name', 'nickname', 'role', 'description', 'motivation',
            'color_code', 'introduction_book', 'introduction_chapter', 'is_active'
        ]
        widgets = {
...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = Event
        fields = [
            'title', 'description', 'book', 'chapter', 'sequence_order',
            'chronological_order', 'story_date', 'location', 'pov_character',
            'characters', 'emotional_tone', 'story_beat', 'tension_level',
            'tags', 'notes', 'word_count', 'is_written'
        ]
        widgets = {
            'title': forms.TextInput(attrs={'class': 'form-control'}),
